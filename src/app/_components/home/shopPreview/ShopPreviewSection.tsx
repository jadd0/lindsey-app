...
export default function BackgroundSectionHeading() {
  ...
  return (
    <div className="w-screen flex flex-col items-start justify-start mt-[20vh]">
      <div className="flex items-start justify-start pt-6">
        <Image
          src="/exploreFavourites.png"
      ...
      <div className="w-screen flex justify-center items-center">
        <div className="w-[80vw] grid gap-6 grid-cols-1 md:grid-cols-3">
